$(function(){
    ...
    $('#remove1').click(function(){
        $('#picfile1').val("");
        $('#clickup1').css("background-image",'url(../views/image/dfpic.png)');
        $('#remove1').hide();
    });
    ...
    $('#remove2').click(function(){
        $('#picfile2').val("");
        $('#clickup2').css("background-image",'url(../views/image/dfpic.png)');
        $('#remove2').hide();
    });
    ...
    $('#remove3').click(function(){
        $('#picfile3').val("");
        $('#clickup3').css("background-image",'url(../views/image/dfpic.png)');
        $('#remove3').hide();
    });
    ...
    $('#remove4').click(function(){
        $('#picfile4').val("");
        $('#clickup4').css("background-image",'url(../views/image/dfpic.png)');
        $('#remove4').hide();
    });
    ...
    $('#remove5').click(function(){
        $('#picfile5').val("");
        $('#clickup5').css("background-image",'url(../views/image/dfpic.png)');
        $('#remove5').hide();
    });
    ...
    $('#remove6').click(function(){
        $('#picfile6').val("");
        $('#clickup6').css("background-image",'url(../views/image/dfpic.png)');
        $('#remove6').hide();
    });

    $('#remove7').click(function(){
        $('#picfile7').val("");
        $('#clickup7').css("background-image",'url(../views/image/dfpic.png)');
        $('#remove7').hide();
    });

    $('#remove8').click(function(){
        $('#picfile8').val("");
        $('#clickup8').css("background-image",'url(../views/image/dfpic.png)');
        $('#remove8').hide();
    });

    $('#remove9').click(function(){
        $('#picfile9').val("");
        $('#clickup9').css("background-image",'url(../views/image/dfpic.png)');
        $('#remove9').hide();
    });
